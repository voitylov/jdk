  ...
  case Bytecodes::_fast_sputfield:
    {
      ...
      volatile_barrier(MacroAssembler::Membar_mask_bits(MacroAssembler::LoadLoad | MacroAssembler::LoadStore), noreg, true);
...
void TemplateTable::resolve_cache_and_index_for_field(int byte_no,
  ...
  __ cmp(Rtemp, (int) code);  // have we resolved this bytecode?
  __ b(resolved, eq);
